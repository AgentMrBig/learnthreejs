...
var api5mMultipleCandles = `https://www.alphavantage.co/query?function=FX_INTRADAY&from_symbol=${firstSymbol}&to_symbol=${secondSymbol}&interval=5min&apikey=${alphaAvantageAPIKey}`;

var api5mSingleCandle = `https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=${firstSymbol}&to_currency=${secondSymbol}&apikey=${alphaAvantageAPIKey}`
...
var apiBidPrice = "8. Bid Price";
var apiAskPrice = "9. Ask Price";

// variables for holding ideal data
...
//console.log(apiData['Realtime Currency Exchange Rate']);
